...
if (
  ...
  const action_2 = +prompt(
    "Well, how would you estimate my hw? In scale 1-100 ",
    ""
  );
  if (action_2 >= 1 && action_2 < 90) {
    prompt("Its a pity, how can i correct my work?");
    alert(
      "Understood, i will do everything in my power to complete your decrees :) "
    );
